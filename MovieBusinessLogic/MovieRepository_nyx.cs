...
namespace MovieRepository.MySQL
{
    ...
    {
        private string connString = "server=localhost;database=movie;uid=root;pwd=123456;Allow User Variables=True";
                ...
                try
                {
                    ...
                    while (reader.Read())
                    {
                        result.Add(new Complaint()
                        {
                            ...
                            userID = reader.GetString(1),
                            ComplaintContent = reader.GetString(2),
                            isReply = reader.GetInt16(3),
                        });
                    }
